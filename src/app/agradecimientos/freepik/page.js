         ...
         <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-center mt-5 mb-10 text-3xl lg:text-5xl font-bold">
               ...
               <a 
                  ...
                  className="text-primary-freepik ml-3 uppercase"
                  >
                  Freepik
               </a>
            </h1>
            <p className="text-center text-gray-600 mb-8">
               Queremos expresar nuestro agradecimiento a Freepik por proporcionar las siguientes imágenes utilizadas en
               nuestro proyecto:
            </p>
                  ...
                  {images.map((image, key) => (
                     <li key={key} className="px-6 py-4 hover:bg-primary-yellow/5">
                        <div className="flex items-center space-x-4">
                           <div className="flex-shrink-0 w-36 h-20 bg-gray-100 rounded-lg overflow-hidden">
                              <Image
                                 src={image.image}
                                 alt={image.title}
                                 width={150}
            ...
            <p className="mt-8 text-center text-gray-600">
               Todas las imágenes son propiedad de sus respectivos autores y se utilizan bajo la licencia de Freepik.
            </p>
         </div>
      </div>
   );
