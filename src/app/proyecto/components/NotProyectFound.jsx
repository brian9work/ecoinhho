    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="text-center">
                ...
                <h2 className="text-4xl font-bold text-gray-700 mt-4">Proyecto no encontrado</h2>
                <p className="text-gray-600 mt-4 mb-8">Lo sentimos, el proyecto que estás buscando no existe o ha sido movido.</p>
                <Link
