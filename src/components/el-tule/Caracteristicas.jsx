...
export function CaracteristicasElTule() {
   return (
      <div>
         <AnimatedCSSTitle
         ...
         <div className='mt-5 w-11/12 mx-auto max-w-1200'>
            ...
            <p className='text-center text-lg md:text-xl lg:text-2xl font-Catamaran flex gap-2'>
               ...
               Disfruta la vida que sueñas en tu nuevo hogar en San Lucas Cuauhtelulpan, Tlaxcala. Disfrutando los mejores momentos con tu familia y atesorar cada momento especial.
               <b className='text-xl md:text-3xl lg:text-5xl text-primary-yellow'>"</b>
            </p>
         </div>
