...
const PrincipalText=({url, children})=>{
   return <h4 className='text-primary-yellow font-bold text-4xl'>{children}</h4>
}
const CategoryText=({children})=>{
   return <h4 className='text-yellow-50 font-bold text-xl '>{children}</h4>
}
const NormalText=({url, children})=>{
   return <h4 className='text-yellow-50 text-xl pl-10 py-1 hover:text-primary-yellow '>{children}</h4>
}
